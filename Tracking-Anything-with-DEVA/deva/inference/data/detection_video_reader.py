...
class DetectionVideoReader(Dataset):
    ...
    def __init__(self,
        ...
        #Format differences between our modifications and the original
        ...
        #Original formatting, switch the comments to restore original functionality.
        # self.palette = Image.open(path.join(mask_dir, self.frames[0])).getpalette()
        # self.first_gt_path = path.join(self.mask_dir, self.frames[0])
